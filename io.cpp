                ...
                )
{
    ...
    while(true){
        ...
        if(dest_based){
            graph.adj[dest].push_back(edge);
            edges++;

            if(undirected){
                edge_t back_edge { dest, src, weight };
                graph.adj[src].push_back( back_edge );
                edges++;
            }
        }
        else {
            ...
            if(undirected){
                edge_t back_edge { dest, src, weight };
                graph.adj[dest].push_back( back_edge );
                edges++;
            }
        }
